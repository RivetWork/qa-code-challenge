...
import { selectPageSize, selectDensity } from '@features/settings/state/settingsSelectors';
...
export default function PokemonListPage() {
  ...
  const { items, isLoading, isFetching, isError, error } = useGetPokemonListQuery(
